...
const Contact = () => {
  return (
    ...
    className="bg-[url('/images/bg2.jpg')] bg-cover bg-no repeat h-screen py-11" >
        ...
        <h1 className="text-center font-bold text-5xl text-yellow-400 shadow-2xl shadow-sky-950 ">
                CONTACT ME
            </h1>
          <div className="flex justify-center"> 
            <div className=" bg-[url('/images/contact.png')]  lg:w-[500px] lg:h-[350px] bg-cover ">
            </div>
            </div> 

            <div className="flex justify-between mx-28 px-11"> 

            <div className=" grid grid-cols-1 md:grid-cols-2   w-80  md:w-[80%] md:h-[80%]  border-black text-center">
        <div className="m-1 space-y-1 text-black text-md  font-serif ">
          <div>
          ...
          <div>
            ...
            <textarea
              id="text"
              rows={20}
              className="w-full p-2 rounded-md   border-2  border-black text-sky-950 h-32 md:h-24  text-center"
            />
        ...
        <div className=" flex-col  "> 
            ...
            <h2 className="text-xl text-sky-950 mt-2 mx-5"> 0340-1234567</h2>
            </div>
        </div>
